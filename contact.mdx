...
<AccordionGroup>
  <Accordion title="Is this a bug or a feature request?" icon="circle-question">
  ...
  <Accordion title="Should I send the same request again?" icon="rotate">
  ...
  <Accordion title="Where can I find help with my settings?" icon="gear">
  ...
  <Accordion title="Can support help with an urgent medical problem?" icon="circle-question">
